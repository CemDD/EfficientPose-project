...
def main():
    ...
    #input parameter
    path_to_images = "/home/cem/İndirilenler/Linemod_preprocessed/data/01/toinference"
    image_extension = ".png"
    phi = 3
    path_to_weights = "/home/cem/EfficientPose/models/mext.h5"
    save_path = "/home/cem/EfficientPose/models/inferenced" #where to save the images or None if the images should be displayed and not saved
    # save_path = None
    #class_to_name = {0: "ape", 1: "can", 2: "cat", 3: "driller", 4: "duck", 5: "eggbox", 6: "glue", 7: "holepuncher"} #Occlusion
    class_to_name = {0: "mext"} #Linemod use a single class with a name of the Linemod objects
    score_threshold = 0.5
...
def get_linemod_3d_bboxes():
    ...
    """
    name_to_model_info = {"mext":            {"diameter": 24.3755, "min_x": -30.748325, "min_y": -6.27927, "min_z": -29.612345, "size_x": 69.49665, "size_y": 12.55854, "size_z": 67.22469},
